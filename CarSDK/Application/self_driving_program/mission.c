...
// ÔøΩÔøΩÔøΩÔøΩ structure??? control_mission.h ??? ?????????. 9/8(???)
...
bool parkingFunc(struct thr_data *arg)
{
    ...
    {      // Î∞îÌ?¥Í?? ?†ÑÏßÑÎ∞©?ñ•?ùÑ ?ú†Ïß??ïòÍ≥? ?ûà?äî Í≤ΩÏö∞?óêÎß? Ï£ºÏ∞® Î∂ÑÍ∏∞Î°? ÏßÑÏûÖ?ïò?èÑÎ°? ?ïò?äî ?û•Ïπ? (Í≤∞ÏÑ† Ï£ºÌñâ?ö©)
...
bool overtakeFunc(struct thr_data *arg)
{
    ...
    if (distance_1 <= 20) //????? ???????? ÔøΩÔøΩ??? //ÔøΩÔøΩÔøΩÔøΩ ????????? ?????????, ÔøΩ–±ÔøΩÔøΩÔøΩÔøΩÔøΩ ?????
    {
        printf("\t distance_1 = %d \n", distance_1);
        data->imgData.bmission = true;  //??????√≥ÔøΩÔøΩ X
        data->imgData.btopview = false; //topview off
        //data->imgData.bwhiteLine = true; // ?????? ÔøΩÔøΩÔøΩÔøΩ O
        data->imgData.bprintString = true;
        ...
        while (state)
        {
            ...
            {
            case FRONT_DETECT:
                /* ???????? ÔøΩ¬øÔøΩ????????? ?????? ƒ´ÔøΩÔøΩ??? ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ */
                ...
                /* ???????? ÔøΩ¬øÔøΩ ?????? ?? ÔøΩÔøΩÔø???????? ÔøΩÔøΩÔøΩÔøΩ????? ???ÔøΩÔøΩÔøΩÔøΩ?????? ÔøΩ⁄µÔøΩ*/
                while (data->missionData.overtakingData.headingDirection == STOP)
                {
                    //data->missionData.loopTime = timeCheck(&time);
                    usleep(50000);
                }
                /*?????? ÔøΩÔøΩÔøΩÔøΩ?? Camera ?????? ???ƒ°ÔøΩÔøΩ ?????*/
                if (data->missionData.overtakingData.headingDirection != STOP)
                {
                    ...
                    data->missionData.overtakingData.updownCamera == CAMERA_DOWN)
                {
                    ...
                    { /*????? ÔøΩÔøΩ≈Ω??*/
                        ...
                        /*???ÔøΩÔøΩÔøΩÔøΩ??? ?????? ????? ???????? 20 ?????? ????????? SIDE_ON????? ÔøΩÔøΩÔøΩÔøΩ*/
                        DesireSpeed_Write_uart(BASIC_SPEED);
                        usleep(500000);
                    }
                }
            ...
            case SIDE_ON:
                /*Auto Steering ??????*/
                data->imgData.bmission = false;
                /* ?????? ??????ÔøΩÔøΩÔøΩÔøΩ ?????????????????? ?????? side ??????(2,3 or 4,5)?? ÔøΩÔøΩ????????? ÔøΩ⁄µÔøΩ*/
                //right
                if (data->missionData.overtakingData.headingDirection == RIGHT)
                {
                    /*???????? ????? ??????*/
...
bool signalLightFunc(struct thr_data *arg)
{
    ...
    if (StopLine(4)) // data->missionData.finish_distance != -1) //??????????? ??????????? ÔøΩ≈∏ÔøΩ?? ÔøΩÔøΩÔøΩÔøΩ?????
    {
        // onlyDistance(BASIC_SPEED, (data->missionData.finish_distance / 26.0) * 500); //????????ÔøΩÔøΩ??? ????? stop
        // data->missionData.finish_distance = -1;
        ...
        while (data->imgData.bcheckSignalLight)
            usleep(200000); //??????√≥ÔøΩÔøΩ?????? ????????? ÔøΩÔøΩÔøΩÔøΩ??? ?????? ??? ÔøΩÔøΩ??? ÔøΩÔøΩŸ∏ÔøΩÔøΩÔø??.
        ...
        while (1) // ????????? ÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩÔøΩ??? ÔøΩ≈∏ÔøΩ?? 23,24cm ?? ÔøΩÔøΩÔøΩÔøΩ?? ?????? ?????
        {
