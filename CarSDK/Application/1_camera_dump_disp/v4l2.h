...
int v4l2_streamon(struct v4l2 *v4l2); // stream on
//postcondition: v4l2_dqbuf 가능

int v4l2_streamoff(struct v4l2 *v4l2);
//v4l2 stream을 모두 off --> dqbuf를 모두 마치고 display에 stream안할 때 사용

/* Queue a buffer to the camera */
int v4l2_qbuf(struct v4l2 *v4l2, struct buffer *buf);
// 버퍼에 buf내용을 저장 1버퍼를 enqueue
// postcondition: v4l2 streamon 함수 사용가능
