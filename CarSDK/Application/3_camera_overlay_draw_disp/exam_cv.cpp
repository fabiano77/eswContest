...
/**
  ...
  * @param  src1: pointer to parameter of rgb32 image buffer
             src2: pointer to parameter of ar24 image buffer
             dst : pointer to parameter of rgb output buffer
...
void OpenCV_merge_image(unsigned char* src1, unsigned char* src2, unsigned char* dst, int w, int h)
{
    ...
    Mat dstBGR(h, w, CV_8UC3, dst);   // bgr
    ...
    cvtColor(src1AR32, dstBGR, CV_RGBA2BGR);
}
